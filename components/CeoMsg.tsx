...
const CeoMsg = () => {
  return (
    <section className="bg-black py-24 px-6 md:px-12">
      ...
      >
        <div className="mb-12">
          <p className="text-yellow-400 text-sm font-bold tracking-widest mb-4">FROM THE CEO</p>
          <h2 className="text-5xl md:text-7xl font-black text-white">Our Vision</h2>
        </div>
        
        <div className="text-zinc-400 text-lg space-y-6 mb-12">
          <p>We're building the future of freelance work - where talent meets opportunity without boundaries.</p>
        </div>
