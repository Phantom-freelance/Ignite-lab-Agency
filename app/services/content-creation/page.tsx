    ...
    <main className="bg-black min-h-screen pt-24 pb-16 px-6 md:px-12">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <h1 className="text-6xl md:text-8xl font-black text-white mb-6">Content Creation</h1>
          <p className="text-2xl text-zinc-400 mb-12">Engage your audience with compelling content</p>
