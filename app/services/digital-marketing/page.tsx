    ...
    <main className="bg-black min-h-screen pt-24 pb-16 px-6 md:px-12">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <h1 className="text-6xl md:text-8xl font-black text-white mb-6">Digital Marketing</h1>
          <p className="text-2xl text-zinc-400 mb-12">Grow your business with data-driven strategies</p>
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            <div className="bg-zinc-900 rounded-3xl p-8 border border-zinc-800">
              ...
              <p className="text-zinc-400 mb-6">Let's discuss your project.</p>
              <Link href="/contact">
